//
//  TrackerDataServiceUserDefaultsTests.swift
//  UnitTests
//
...
class TrackerDataServiceUserDefaultsTests: XCTestCase {
    ...
    func testWhenInitializedThenEtagIsNil() {
        let userDefaults = TrackerDataServiceUserDefaults(userDefaults: UserDefaults(suiteName: testGroupName)!)
